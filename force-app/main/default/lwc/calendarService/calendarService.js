...
export default class calendarService extends NavigationMixin(LightningElement) {
    currentPage;
    itemsPerPage;
    ...
    // Todo: when the user selects the start date, they're automatically taken to the 'select end date' calendar.  Can do this by changing making the accordian 'Active'
    // and possibly use the buttons to direct them to the 'room.month' and 'day' from their previous selection, or preferrably just the month.
